...
<head>
    ...
    <?php
    if (isset($_GET['id'])) {
        include("controllers/news_description.php");
    } else {
        echo '<meta name="Description" content="Aktualne wiadmości z życia reggae - reggae newsy. Informacje o festiwalach, koncertach, płytach, trasach koncertowych. Krótko mówiąc - wszystko czego potrzebujecie w jednym miejscu."/>';
    }
    ?>
    <meta name="Keywords"
...
if (!isset($_GET['id']) || $_GET['id'] == '') { ?>
    ...
    <section id="news" class="container marg-top-0">
        <h4 class="row entry-empty col-xs-12"><i class="fa fa-meh-o" aria-hidden="true"> Error 404 Strona o podanym
                adresie nie istnieje</i></h4>
    </section>
    <?php
}
?>
