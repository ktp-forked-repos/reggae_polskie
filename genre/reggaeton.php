...
<head>
   ...
   <?php $CMS->head(); ?>
   <title>Reggaeton music - Reggae Polskie</title>
</head>
<body>
   ...
   <section id="title" class="container">
      <div class="row">
         <div class="col-xs-12 text-center text-red"> <h2 class="title_font"><?php $CMS->Cms_class->display_block('genre_reggaeton_header', 'oneline')?></h2></div>        
      </div>
   </section>
   ...
   <section id="content" class="container">
      <div class="col-sm-10 col-xs-12 marg-top-1">
         <p><?php $CMS->Cms_class->display_block('genre_reggaeton_content')?></p>   
      </div>
   ...
   <section id="video" class="container">
      ...
      <div class="col-sm-10 col-xs-12 marg-top-1">
         <div class="embed-responsive embed-responsive-16by9">
            <?php $video = $CMS->Cms_class->display_video('genre_reggaeton_video'); ?>
