...
<head>
    ...
    <meta name="Description"
          content="Reggae Polskie to wszystko czego potrzebujesz o muzyce reggae w jednym miejscu. Skontaktuj się z nami, a my odpowiemy najszybciej jak tylko będzie to możliwe."/>
    <meta name="Keywords"
          content="reggae, regee, ragga, rege, redzi, regge, raga, polskie+reggae, reggaepolskie, polskiereggae, muzyka, muza, music, polish, polen, soundsystem, kontakt, contact">
...
<section id="name" class="container marg-top-1">
    <div class="col-xs-12 text-center">
        ...
        <h4><a href="mailto:example@tutorialspark.com"><i class="fa fa-envelope" aria-hidden="true"></i> admin&#64;reggaepolskie.pl</a>
        </h4>
    </div>
</section>
<!-- Contact Section -->
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Imię i nazwisko *" id="name" required
                                   data-validation-required-message="Musisz podać swoj imię i nazwisko">
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="form-group">
                            <input type="email" class="form-control" placeholder="Emial *" id="email" required
                                   data-validation-required-message="Musisz podać swój email"
                                   data-validation-email-message="Nieprawidłowy email">
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <textarea class="form-control" placeholder="Treść wiadomości *" id="message" required
                                      data-validation-required-message="Muisz podać treść wiadomości"></textarea>
                            <p class="help-block text-danger"></p>
                        </div>
                    </div>
