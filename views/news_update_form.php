...
<div class="switch_off col-xs-12 offset-button-update">
   <div class="  text-center">
      <button class="btn btn-primary" data-toggle="collapse" data-target="#update_news_form' . $row['news_id'] . '"><i class="fa fa-pencil-square-o" aria-hidden="true"></i><span> Aktualizuj newsa</span></button>
      <div id="update_news_form' . $row['news_id'] . '" class="collapse">
